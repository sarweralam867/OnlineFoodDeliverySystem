...
<div id="resultRestaurant" style=" margin:0px auto; position:fixed; top:150px;right:750px; background:white;  z-index: 3000;"></div>

<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  
    <a class="navbar-brand" href="index.php"><span style="color:red;font-family: 'Impact', cursive;">Fast Delivery</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><!--Restaurant search-->
		     <a href="#" class="nav-link"><form method="post"><input type="text" name="search_Restaurant" id="search_Restaurant" placeholder="Search Restaurants " class="form-control " /></form></a>
		  </li>
          <li class="nav-item">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h3>Gulshan</h3>
        <p>Food delivery from Gulshan’s best restaurants</p>
      </div>   
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3>Dhanmondi</h3>
        <p>Get your favorite food at you door in Dhanmondi</p>
      </div>   
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3>Uttara</h3>
        <p>We delevery you favorite food in Uttara</p>
      </div>   
    </div>
  </div>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family: 'Arial', cursive; font-weight:light;  font-size:25px;">Have a taste!.</p>
	 </div>
	...
	<?php
	  ...
	  {
		   $Restaurant_logo= "image/restaurant/".$res['fld_email']."/".$res['fld_logo'];
		   $food_pic= "image/restaurant/".$res['fld_email']."/foodimages/".$res['fldimage'];
	  ?>
	  <div class="container-fluid">
	  <div class="container-fluid">
	     <div class="row" style="padding:10px; ">
		      <div class="col-sm-2"><img src="<?php echo $Restaurant_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		      <div class="col-sm-5">
	  ...
	  <div class="container-fluid">
		 ...
		 <span><li><?php echo "BDT ".$res['cost']; ?>&nbsp;for 1</li></span>
	                                   ...
	                                   ?>
	                                      <div class="container-fluid">
	                                          <div class="container-fluid"><!--product row container 1-->
	                                               <div class="row" style="padding:10px; ">
		                            <!--Restaurant logo-->  <div class="col-sm-2"><img src="<?php echo $Restaurant_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		                                               <div class="col-sm-5">
		                            <!--Restaurantname-->        <span style="font-family: 'Miriam Libre', sans-serif; font-size:28px;color:#CB202D;"><?php echo $res['fld_name']; ?></span>
                                                       </div>
		                         ...
		                         <!--add to cart-->    <div class="col-sm-2" style="text-align:left;padding:10px; font-size:25px;"><button type="submit"  name="addtocart" value="<?php echo $res['food_id'];?>"><span style="color:green;"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span></button></div>
		                           ...
		                           <!--food Image-->     <div class="col-sm-12"><img src="<?php echo $food_pic; ?>" class="rounded" height="250px" width="100%" alt="Cinque Terre"></div>
		                               ...
		                               <!--cuisine-->          <span><li><?php echo $res['cuisines']; ?></li></span>
		                                <!--cost-->            <span><li><?php echo "BDT ".$res['cost']; ?>&nbsp;for 1</li></span>
...
<div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Arial', cursive; font-weight:light; font-size:25px;">Looks Delicious!</p>
	        </div>
	  </div> 
