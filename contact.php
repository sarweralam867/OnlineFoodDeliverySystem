  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="text" class="form-control" name="phone" placeholder="Phone(optinal) EX 01689271421"/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           ...
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>Contact: 01320000000</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 72, Mohakhali, Dhaka 1213.<br>
