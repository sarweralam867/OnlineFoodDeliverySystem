	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <input type="tel" class="form-control" pattern="[0-9]{1}[0-9]{10}" value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" placeholder="EX 01689271421" name="mob" required/>
                     </div>
	                 <div class="form-group">
                          <label for="phone">Phone:</label>
                          <input type="tel" class="form-control" pattern="[0-9]{1}[0-9]{10}" id="phone" value="<?php if(isset($phone)) { echo $phone;}?>" placeholder="EX 01706050875" name="phone" required>
                     </div>
	                 <div class="form-group">
